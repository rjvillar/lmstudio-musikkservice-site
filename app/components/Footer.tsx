...
import { businessInfo, contactInfo, navigationLinks } from "@/app/lib/data";
...
export default function Footer() {
  ...
  return (
    <footer
      className="bg-primary-dark border-t border-border-subtle"
      role="contentinfo"
    >
      {/* Main Footer Content */}
      <Container>
      ...
      <div className="border-t border-border-subtle">
        <Container>
          <div className="py-6 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-text-muted">
            <p>
              © {currentYear} {businessInfo.name}. Alle rettigheter reservert.
            </p>
            <div className="flex items-center gap-6">
              <span>Org.nr: {contactInfo.orgNumber}</span>
